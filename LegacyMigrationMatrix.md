...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Produit - prix standard | BR-001 | Prix unitaire de base applique au client | app/Services/PriceCalculatorService.php::calculatePrice<br>app/Http/Controllers/CartController.php::resolveProductPrices,getCartPricing | ProductSalesPriceCalculator (runtime cible) | 🟡 En cours | P0 | Resolution acteurs, conditions | Le client voit un prix de base correct | tests/Unit/Services/PriceCalculatorServiceTest.php<br>tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php (partiel)<br>Feature parite panier: A creer | Non | En cours | Shadow |
| Produit - prix carton | BR-002 | Palier carton selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | 🟡 En cours | P0 | Prix standard | Le client paie le bon prix des volumes carton | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
| Produit - prix etage | BR-003 | Palier etage selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | 🟡 En cours | P0 | Prix carton | Le client paie le bon prix des volumes etage | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
...
| Produit - prix roll | BR-005 | Palier roll selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | 🟡 En cours | P0 | Prix etage | Le client paie correctement les gros volumes | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
| Produit - prix promotion | BR-006 | Promo prioritaire sur roll | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | 🟡 En cours | P1 | Prix roll | Le client voit bien la promo appliquee | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
| Produit - prix minimum | BR-007 | Borne basse prix positif | app/Http/Controllers/CartController.php::resolveProductPrices<br>app/Services/PriceCalculatorService.php::applyMargins | Validation metier d entree calcul | 🟡 En cours | P0 | Fallback prix | Evite les lignes a 0 involontaires | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
| Produit - fallback prix | BR-008 | Fallback entre sources de prix | app/Http/Controllers/CartController.php::resolveProductPrices<br>app/Models/Product.php::getPriceRollAttribute | Normalisation reference prix en entree | 🟡 En cours | P0 | Prix standard | Le panier reste calculable meme avec donnees incompletes | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
| Produit - prix speciaux legacy | BR-009 | Source prix historique speciale | app/Services/PriceCalculatorService.php::normalizePriceMode,getSpecialPrice | Mapping metier source de prix | 🟡 En cours | P1 | Fallback prix | Les accords historiques restent respectes pendant migration | tests/Unit/Services/PriceCalculatorServiceTest.php | Non | En cours | Shadow |
...
| Acteurs - BillingUser | BR-011 | Acteur qui facture le client | app/Services/OrderSnapshotService.php::resolveActors<br>app/Http/Controllers/CartController.php::buildPdfPayload | Service metier unique de resolution acteurs | 🟡 En cours | P0 | Client, DB Owner | Le client et le facturant voient un flux coherent | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
| Acteurs - SellerUser | BR-012 | Acteur commercial de la relation | app/Services/OrderSnapshotService.php::resolveActors<br>app/Http/Controllers/CartController.php::buildPdfPayload | Service metier unique de resolution acteurs | 🟡 En cours | P1 | BillingUser | Le commercial est rattache sans ambiguite | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
| Acteurs - Client | BR-013 | Beneficiaire du prix final | app/Http/Controllers/CartController.php (checkout,placeOrder) | Input metier runtime unique | 🟡 En cours | P0 | BillingUser | Le client obtient un total final stable | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
...
| Conditions - marge minimum mm | BR-016 | Minimum de marge reparti | app/Services/PriceCalculatorService.php::applyMargins | Operation metier dediee (cible) | 🟡 En cours | P1 | Prix roll | La marge minimale est respectee | tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php | Non | En cours | Shadow |
| Conditions - ponderation pd | BR-017 | Coefficient historique de ponderation | app/Services/PriceCalculatorService.php::applyMargins | Operation metier dediee (cible) | 🟡 En cours | P1 | Prix standard | Le prix suit les regles historiques attendues | tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php | Non | En cours | Shadow |
| Conditions - heritage | BR-018 | Heritage des conditions commerciales | app/Services/OrderSnapshotService.php::resolveConditionsSnapshot | Service de resolution conditions (cible) | 🟡 En cours | P1 | Resolution acteurs | Les conditions sont coherentes sur la chaine commerciale | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
| Conditions - profils | BR-019 | Profils de conditions facturant | app/Services/OrderSnapshotService.php::extractDefaultConditions | Service de resolution conditions (cible) | 🟡 En cours | P1 | Heritage | Le facturant applique rapidement la bonne politique | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
| Conditions - profil actif relation | BR-020 | Profil effectif facturant-commercial | app/Services/OrderSnapshotService.php::resolveConditionsSnapshot | Service de resolution conditions (cible) | 🟡 En cours | P1 | Profils | Le bon profil est applique sans erreur | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
| Conditions - override client | BR-021 | Surcharge client prioritaire | app/Services/OrderSnapshotService.php::resolveConditionsSnapshot | Service de resolution conditions (cible) | 🟡 En cours | P1 | Profil actif relation | Les accords client specifiques sont respectes | tests/Feature/Domain/Sales/OrderSnapshotServiceTest.php | Non | En cours | Shadow |
