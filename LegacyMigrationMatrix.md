...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Produit - prix standard | BR-001 | Prix unitaire de base applique au client | app/Services/PriceCalculatorService.php::calculatePrice<br>app/Http/Controllers/CartController.php::resolveProductPrices,getCartPricing | ProductSalesPriceCalculator (runtime cible) | 🟡 En cours | P0 | Resolution acteurs, conditions | Le client voit un prix de base correct | tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php (partiel)<br>Feature parite panier: A creer | Non | En cours | Shadow |
| Produit - prix carton | BR-002 | Palier carton selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | ⚪ Pas commence | P0 | Prix standard | Le client paie le bon prix des volumes carton | A creer | Non | 0 % | Legacy |
| Produit - prix etage | BR-003 | Palier etage selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | ⚪ Pas commence | P0 | Prix carton | Le client paie le bon prix des volumes etage | A creer | Non | 0 % | Legacy |
...
| Produit - prix roll | BR-005 | Palier roll selon quantite | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | ⚪ Pas commence | P0 | Prix etage | Le client paie correctement les gros volumes | A creer | Non | 0 % | Legacy |
| Produit - prix promotion | BR-006 | Promo prioritaire sur roll | app/Http/Controllers/CartController.php::getCartPricing | ProductSalesPriceCalculator + preparation input ligne | ⚪ Pas commence | P1 | Prix roll | Le client voit bien la promo appliquee | A creer | Non | 0 % | Legacy |
| Produit - prix minimum | BR-007 | Borne basse prix positif | app/Http/Controllers/CartController.php::resolveProductPrices<br>app/Services/PriceCalculatorService.php::applyMargins | Validation metier d entree calcul | ⚪ Pas commence | P0 | Fallback prix | Evite les lignes a 0 involontaires | A creer | Non | 0 % | Legacy |
| Produit - fallback prix | BR-008 | Fallback entre sources de prix | app/Http/Controllers/CartController.php::resolveProductPrices<br>app/Models/Product.php::getPriceRollAttribute | Normalisation reference prix en entree | ⚪ Pas commence | P0 | Prix standard | Le panier reste calculable meme avec donnees incompletes | A creer | Non | 0 % | Legacy |
| Produit - prix speciaux legacy | BR-009 | Source prix historique speciale | app/Services/PriceCalculatorService.php::normalizePriceMode,getSpecialPrice | Mapping metier source de prix | ⚪ Pas commence | P1 | Fallback prix | Les accords historiques restent respectes pendant migration | A creer | Non | 0 % | Legacy |
...
| Acteurs - BillingUser | BR-011 | Acteur qui facture le client | app/Services/OrderSnapshotService.php::resolveActors<br>app/Http/Controllers/CartController.php::buildPdfPayload | Service metier unique de resolution acteurs | ⚪ Pas commence | P0 | Client, DB Owner | Le client et le facturant voient un flux coherent | A creer | Non | 0 % | Legacy |
| Acteurs - SellerUser | BR-012 | Acteur commercial de la relation | app/Services/OrderSnapshotService.php::resolveActors<br>app/Http/Controllers/CartController.php::buildPdfPayload | Service metier unique de resolution acteurs | ⚪ Pas commence | P1 | BillingUser | Le commercial est rattache sans ambiguite | A creer | Non | 0 % | Legacy |
| Acteurs - Client | BR-013 | Beneficiaire du prix final | app/Http/Controllers/CartController.php (checkout,placeOrder) | Input metier runtime unique | ⚪ Pas commence | P0 | BillingUser | Le client obtient un total final stable | A creer | Non | 0 % | Legacy |
| Conditions - marge facturant | BR-014 | Marge facturant sur base DB | app/Services/PriceCalculatorService.php::applyMargins | ProductSalesPriceCalculator | 🟡 En cours | P1 | Prix standard, BillingUser | Le facturant voit son gain conforme | tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php | Non | En cours | Shadow |
| Conditions - marge commercial | BR-015 | Marge commercial sur base DB | app/Services/PriceCalculatorService.php::applyMargins | ProductSalesPriceCalculator | 🟡 En cours | P1 | Marge facturant, SellerUser | Le commercial voit son gain brut reel | tests/Unit/Domain/Sales/ProductSalesPriceCalculatorTest.php | Non | En cours | Shadow |
| Conditions - marge minimum mm | BR-016 | Minimum de marge reparti | app/Services/PriceCalculatorService.php::applyMargins | Operation metier dediee (cible) | ⚪ Pas commence | P1 | Prix roll | La marge minimale est respectee | A creer | Non | 0 % | Legacy |
| Conditions - ponderation pd | BR-017 | Coefficient historique de ponderation | app/Services/PriceCalculatorService.php::applyMargins | Operation metier dediee (cible) | ⚪ Pas commence | P1 | Prix standard | Le prix suit les regles historiques attendues | A creer | Non | 0 % | Legacy |
| Conditions - heritage | BR-018 | Heritage des conditions commerciales | app/Services/PriceCalculatorService.php::calculateBasePrices | Service de resolution conditions (cible) | ⚪ Pas commence | P1 | Resolution acteurs | Les conditions sont coherentes sur la chaine commerciale | A creer | Non | 0 % | Legacy |
| Conditions - profils | BR-019 | Profils de conditions facturant | app/Services/OrderSnapshotService.php::extractDefaultConditions | Service de resolution conditions (cible) | ⚪ Pas commence | P1 | Heritage | Le facturant applique rapidement la bonne politique | A creer | Non | 0 % | Legacy |
| Conditions - profil actif relation | BR-020 | Profil effectif facturant-commercial | app/Services/OrderSnapshotService.php::resolveConditionsSnapshot | Service de resolution conditions (cible) | ⚪ Pas commence | P1 | Profils | Le bon profil est applique sans erreur | A creer | Non | 0 % | Legacy |
| Conditions - override client | BR-021 | Surcharge client prioritaire | app/Services/OrderSnapshotService.php::resolveConditionsSnapshot | Service de resolution conditions (cible) | ⚪ Pas commence | P1 | Profil actif relation | Les accords client specifiques sont respectes | A creer | Non | 0 % | Legacy |
...
| Transport - minimum | BR-034 | Minimum monetaire transport | app/Http/Controllers/CartController.php::pickZoneTariff | Service de tarification transport (cible) | ⚪ Pas commence | P0 | Transport depart, zone | Le cout minimum est coherent avec la politique transport | A creer | Non | 0 % | Legacy |
| Transport - zone | BR-035 | Tarification par zone | app/Http/Controllers/CartController.php::pickZoneTariff,parseTariffRange | Service de tarification transport (cible) | ⚪ Pas commence | P0 | Choix transporteur | Le client paie selon sa zone de livraison | A creer | Non | 0 % | Legacy |
| Transport - transporteur applicable | BR-036 | Transporteur applicable au contexte | app/Http/Controllers/CartController.php::buildPdfPayload | Resolution transport metier (cible) | ⚪ Pas commence | P1 | Acteurs, zone | Le bon transporteur est utilise pour le calcul | A creer | Non | 0 % | Legacy |
| Transport - choix transporteur | BR-037 | Choix coherent avec regles autorisees | Regle dispersee | Validation metier transport (cible) | ⚪ Pas commence | P1 | Transporteur applicable | Le client choisit un transporteur valide | A creer | Non | 0 % | Legacy |
| Logistique - cartons | BR-038 | Conversion en cartons | app/Services/PdfRollDistributionService.php::firstTri | Service logistique metier (cible) | ⚪ Pas commence | P0 | Conditionnements produit | Le transport est base sur des volumes reels | A creer | Non | 0 % | Legacy |
| Logistique - etages | BR-039 | Organisation en etages | app/Services/PdfRollDistributionService.php::buildFullEtage,binpack | Service logistique metier (cible) | ⚪ Pas commence | P0 | Cartons | Le calcul de remplissage est realiste | A creer | Non | 0 % | Legacy |
...
| Logistique - rolls | BR-041 | Regroupement final en rolls | app/Services/PdfRollDistributionService.php::build,binpack | Service logistique metier (cible) | ⚪ Pas commence | P0 | Etages | Le nombre de rolls est exact | A creer | Non | 0 % | Legacy |
| Logistique - remplissage | BR-042 | Taux d occupation des rolls | app/Services/PdfRollDistributionService.php::binpack<br>app/Http/Controllers/CartController.php::tariffToFillRatio | Input transport roll occupancy (cible) | ⚪ Pas commence | P0 | Rolls | Le transport rendu reflete l occupation reelle | A creer | Non | 0 % | Legacy |
| Logistique - multi-producteurs | BR-043 | Segmentation par producteur/base | app/Services/PdfRollDistributionService.php::buildSupplierTri | Service logistique metier (cible) | ⚪ Pas commence | P1 | Rolls | Le calcul reste juste sur paniers mixtes | A creer | Non | 0 % | Legacy |
| Logistique - regroupement | BR-044 | Regroupement optimisant expedition | app/Services/PdfRollDistributionService.php::binpack | Service logistique metier (cible) | ⚪ Pas commence | P1 | Multi-producteurs | Cout logistique potentiellement reduit | A creer | Non | 0 % | Legacy |
| Commande - calcul panier | BR-045 | Total panier produit + transport | app/Http/Controllers/CartController.php::getCartPricing,buildPdfPayload,computeShippingFromRollDistribution | OrderSalesChainCalculator (runtime cible) | ⚪ Pas commence | P0 | Prix, TVA, transport | Le client voit le bon total avant validation | Tests feature checkout: A creer | Non | 0 % | Legacy |
...
| Reversements - transporteur | BR-052 | Reversement cout transport | Legacy non centralise | ExpectedSettlementBuilder (cible a completer) | ⚪ Pas commence | P3 | Cout reel transport | Le cout transport est affecte au bon acteur | A creer | Non | 0 % | Legacy |
