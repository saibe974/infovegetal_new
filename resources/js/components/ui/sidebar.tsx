...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex max-w-full min-h-[calc(100svh-var(--app-header-height,64px)-56px)] flex-1 flex-col",
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        // "group-data-[collapsible=icon]:hidden",
        "group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:mx-0 group-data-[collapsible=icon]:translate-x-0 group-data-[collapsible=icon]:border-0",
        className
      )}
      {...props}
    />
