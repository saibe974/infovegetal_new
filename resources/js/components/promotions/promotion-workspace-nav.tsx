    ...
    return (
        <div className="min-w-0 self-start">
            <StickyBar
                ...
                zIndex={15}
                borderBottom={false}
                topOffsetElement=".top-sticky, .promotion-page-header"
                boundaryElement=".promotion-workspace"
            >
                <nav className="w-full space-y-1 lg:max-h-[max(6rem,calc(100dvh-var(--sticky-top-offset)-1rem))] lg:overflow-y-auto lg:overscroll-contain" aria-label="Sections de la promotion">
