...
class DbProductsController extends Controller
{
    ...
    private function validateBillingPayload(Request $request): array
    {
        return $request->validate([
            ...
            'billing_users.*.defaults.default_profile_id' => ['nullable', 'string', 'max:190'],
            'billing_users.*.defaults.profiles' => ['nullable', 'array'],
            'billing_users.*.defaults.profiles.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.profiles.*.name' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.profiles.*.conditions' => ['nullable', 'array'],
            ...
            'billing_users.*.defaults.files.*.events' => ['nullable', 'array', 'min:1'],
            'billing_users.*.defaults.files.*.events.*' => ['required', Rule::in(['order', 'delivery', 'invoice', 'credit_note'])],
            ...
            'billing_users.*.defaults.files.*.columns.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.columns.*.name' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.rows' => ['nullable', 'array'],
            'billing_users.*.defaults.files.*.rows.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.rows.*.cells' => ['required', 'array'],
            'billing_users.*.defaults.files.*.rows.*.cells.*' => ['nullable', 'string', 'max:5000'],
            'billing_users.*.defaults.files.*.blocks' => ['nullable', 'array'],
            'billing_users.*.defaults.files.*.blocks.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.blocks.*.name' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.blocks.*.type' => ['required', Rule::in(['header', 'items', 'footer'])],
            'billing_users.*.defaults.files.*.blocks.*.enabled' => ['required', 'boolean'],
            'billing_users.*.defaults.files.*.blocks.*.show_headers' => ['required', 'boolean'],
            'billing_users.*.defaults.files.*.blocks.*.columns' => ['required', 'array', 'min:1'],
            'billing_users.*.defaults.files.*.blocks.*.columns.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.blocks.*.columns.*.name' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.blocks.*.rows' => ['required', 'array'],
            'billing_users.*.defaults.files.*.blocks.*.rows.*.id' => ['required', 'string', 'max:190'],
            'billing_users.*.defaults.files.*.blocks.*.rows.*.cells' => ['required', 'array'],
            'billing_users.*.defaults.files.*.blocks.*.rows.*.cells.*' => ['nullable', 'string', 'max:5000'],
